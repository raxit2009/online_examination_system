...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { correct: @option.correct, quistion_id: @option.quistion_id, text: @option.text }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { correct: @option.correct, quistion_id: @option.quistion_id, text: @option.text }
    assert_redirected_to option_path(assigns(:option))
  end
